...
for (int i = 0; i <= 9000000; i++){
  ...
  do{
	...
	char s[] = "PRINT";
    if (addthis[1] == 'P' && addthis[2] == 'R' && addthis[3] == 'I' && addthis[4] == 'N' && addthis[5] == 'T'){
    if (addthis[7] == '\0'){
	print_new_line();
	...
	chas = 1;
    } else if (addthis[1] == 'S' && addthis[2] == 'C' && addthis[3] == 'R' && addthis[4] == 'I' && addthis[5] == 'P' && addthis[6] == 'T'){
    	if (addthis[7] == '\0'){
	print_new_line();
      ...
      print_new_line();
		...
		if (scriptvalue[1] == 'H' && scriptvalue[2] == 'E' && scriptvalue[3] == 'L' && scriptvalue[4] == 'L' && scriptvalue[5] == 'O' && scriptvalue[6] == '.' && scriptvalue[7] == 'S'){
	...
	} else if (addthis[1] == 'E' && addthis[2] == 'D' && addthis[3] == 'I' && addthis[4] == 'T'){
    if (addthis[6] == '\0'){
	print_new_line();
	...
	} else if (addthis[1] == 'E' && addthis[2] == 'R' && addthis[3] == 'A' && addthis[4] == 'S' && addthis[5] == 'E') {
		clear_screen();
		print_string("SHELL* ")
	} else {
